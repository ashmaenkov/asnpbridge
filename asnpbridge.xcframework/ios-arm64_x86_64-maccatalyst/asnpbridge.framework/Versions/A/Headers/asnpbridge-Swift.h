...
#ifndef ASNPBRIDGE_SWIFT_H
#define ASNPBRIDGE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="asnpbridge",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface Account (SWIFT_EXTENSION(asnpbridge))
...
@interface AuthHistory (SWIFT_EXTENSION(asnpbridge))
...
SWIFT_CLASS("_TtC10asnpbridge14NetworkManager")
@interface NetworkManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC10asnpbridge18NoPassConfigurator")
...
SWIFT_CLASS("_TtC10asnpbridge15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(asnpbridge)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(asnpbridge)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(asnpbridge)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC10asnpbridge12TaskDelegate")
